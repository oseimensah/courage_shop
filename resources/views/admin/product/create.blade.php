    ...
    <div class="py-12">
        <div class="bg-white p-3 rounded-md shadow-lg w-full">
            <div class="w-full max-w-7xl mx-auto py-8">
                <h2 class="pl-10">Add new product</h2>
                <br>
                <form method="POST" enctype="multipart/form-data"  action="{{ route('admin.product.store') }}" class="px-10">
                    @csrf
                    <div class="grid grid-cols-2 gap-4 m-0 p-0">
                        <div class="">
                            <x-input-label for="category" :value="__('Category')" />
                            <select id="category" name="category" class="mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                        ...
                        <div class="">
                            ...
                            <x-text-input id="price" class="block mt-1 w-full" type="number" min="0" value="0" step=".01" name="price" :value="old('price')" required autofocus />
                        ...
                        <div class="">
                            <label for="featured" class="inline-flex items-center">
                                <input id="featured" type="checkbox" class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-primary shadow-sm focus:ring-primary dark:focus:ring-primary dark:focus:ring-offset-primary" name="featured">
